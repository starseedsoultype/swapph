...
## 13. Что не реализовано (v2)

- `swapph-notify` — уведомление владельцу когда кто-то нажимает Want
- Индексы на listings (created_at, city, category, type)
- Rollback listing при неудачной загрузке фото
- Supabase migrations и Edge Functions в GitHub репозитории
